...
namespace AspNetCore.CleanStart
{
    ...
    public class Startup : IStartup
    {
        ...
        /// </summary>
        /// <remarks>
        /// Called by <see cref="MvcServiceCollectionExtensions.AddMvc(IServiceCollection,Action{MvcOptions})"/> inside <see cref="ConfigureServices"/>.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Called by <see cref="MvcApplicationBuilderExtensions.UseMvc(IApplicationBuilder,Action{IRouteBuilder})"/> inside <see cref="ConfigureApplication"/>.
        /// <para>
        /// No routes are added as this is the default setup for .NET Core.
        /// The intent is that attribute routing (https://docs.microsoft.com/en-us/aspnet/core/mvc/controllers/routing#attribute-routing) will be used.
        /// </para>
        /// </remarks>
